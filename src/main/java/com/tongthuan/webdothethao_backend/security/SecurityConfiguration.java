        ...
        httpSecurity
                ...
                .authorizeHttpRequests(
                        configure -> configure
                                ...
                                .permitAll()
                                .requestMatchers(HttpMethod.PUT, EndPoints.PUBLIC_PUT_ENDPOINTS)
                                .permitAll()
                                .requestMatchers(HttpMethod.GET, EndPoints.CUSTOMER_GET_ENDPOINTS)
                                .hasAuthority("CUSTOMER")
                                .requestMatchers(HttpMethod.POST, EndPoints.CUSTOMER_POST_ENDPOINTS)
                                .hasAuthority("CUSTOMER")
                                .requestMatchers(HttpMethod.PUT, EndPoints.CUSTOMER_PUT_ENDPOINTS)
                                .hasAuthority("CUSTOMER")
                                .requestMatchers(HttpMethod.DELETE, EndPoints.CUSTOMER_DELETE_ENDPOINTS)
                                .hasAuthority("CUSTOMER")
                                ...
                                .hasAnyAuthority("ADMIN", "STAFF")
                                .requestMatchers(HttpMethod.PUT, EndPoints.ADMIN_PUT_ENDPOINTS)
                                .hasAnyAuthority("ADMIN", "STAFF")
                                .requestMatchers(HttpMethod.DELETE, EndPoints.ADMIN_DELETE_ENDPOINTS)
                                .hasAnyAuthority("ADMIN", "STAFF")
                                .requestMatchers(HttpMethod.GET, EndPoints.HAS_ROLE_GET_ENDPOINTS)
                                .hasAnyAuthority("ADMIN", "CUSTOMER", "STAFF")
                                //
                                // .requestMatchers(HttpMethod.POST,EndPoints.HAS_ROLE_POST_ENDPOINTS).hasAnyAuthority("ADMIN","CUSTOMER","STAFF")
                                .requestMatchers(HttpMethod.POST, EndPoints.HAS_ROLE_POST_ENDPOINTS)
                                .permitAll()
                                .anyRequest()
                                .authenticated() // Bắt buộc phải xác thực mới vào
                        )
